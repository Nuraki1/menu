...
const NavLink = ({ children, href, idx }) => {
  return (
    <motion.a
      ...
      exit={{ opacity: 0, y: -8 }}
      href={href}
      className="block text-2xl text-2sm font-bold text-gray from-neutral-950 transition-colors hover:text-gray-500 md:text-7xl"
    >
      {children}
    </motion.a>
  );
...
const Logo = () => {
  ...
  return (
    <motion.a
      ...
      exit={{ opacity: 0, y: -12 }}
      href="#"
      className="grid h-20 w-20 place-content-center rounded-br-xl rounded-tl-xl bg-customYellow transition-colors hover:bg-customRed"
    >
  ...
  return (
    <>
      <motion.div
        ...
        className="fixed z-10 rounded-xl bg-gradient-to-br from-customLightRed to-customRed shadow-lg shadow-violet-800/20"
      />
  ...
  return (
    <>
      ...
      <motion.button
        ...
        exit={{ opacity: 0, y: 8 }}
        className="absolute bottom-2 right-2 flex items-center gap-2 rounded-full bg-customYellow px-3 py-3 text-4xl uppercase text-gray transition-colors hover:bg-customYellow hover:text-gray-300 md:bottom-4 md:right-4 md:px-6 md:text-2xl"
      >
